...
## Git Conventions
- **Always use a new branch** for code updates (features, patches, bug fixes, etc.) — never commit directly to `main`
...
- Do NOT mention Mistral, Vibe, or any AI code assistant in commit messages
