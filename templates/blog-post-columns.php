 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Blog Post Columns"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|x-large"}},"backgroundColor":"base","layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-group has-base-background-color has-background" style="gap:var(--wp--preset--spacing--small);border-radius:5px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:group {"metadata":{"name":"Post Content"},"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group has-secondary-color has-text-color has-link-color has-x-small-font-size" style="gap:5px"><!-- wp:paragraph -->
<p>·</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="gap:var(--wp--preset--spacing--small)"><!-- wp:post-title {"isLink":true,"style":{"typography":{"textDecoration":"none","fontStyle":"normal","fontWeight":"600","lineHeight":"1.3"},"border":{"bottom":{"width":"0px"}}},"fontSize":"medium","fontFamily":"bitter","className":"has-partial-underline has-partial-underline-center has-partial-underline-third"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
