...
<p class="has-text-align-center has-main-accent-color has-text-color has-medium-font-size"><?php esc_html_e( 'TODO: Supporting description text.', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-main-color has-text-color has-medium-font-size"><?php esc_html_e( 'TODO: Name', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"primary","fontSize":"base"} -->
<p class="has-primary-color has-text-color has-base-font-size"><strong><?php esc_html_e( 'TODO: Job title', 'elayne' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"main-accent","fontSize":"base"} -->
<p class="has-main-accent-color has-text-color has-base-font-size"><?php esc_html_e( 'TODO: Short bio for this team member.', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
